...
(1, 'DATA_QUERY', 'Query', 1, NULL),
(2, 'DATA_MANAGEMENT', 'Edit', 2, NULL),
(4, 'VIEW_MANAGEMENT', 'View', 4, NULL),
(5, 'ADMIN', 'Administration', 5, NULL),
(6, 'DESIGNING_CI_DATA_ENQUIRY', 'CI Data', 6, 1),
(7, 'DESIGNING_CI_INTEGRATED_QUERY_EXECUTION', 'Execute Customized Query', 7, 1),
(8, 'CMDB_DESIGNING_ENUM_ENQUIRY', 'Enum', 8, 1),
(9, 'DESIGNING_CI_DATA_MANAGEMENT', 'CI Data', 9, 2),
(10, 'DESIGNING_CI_INTEGRATED_QUERY_MANAGEMENT', 'Customized Query', 10, 2),
(11, 'CMDB_DESIGNING_ENUM_MANAGEMENT', 'Enum', 11, 2),
...
(22, 'CMDB_ADMIN_BASE_DATA_MANAGEMENT', 'System Enum', 22, 5),
