...
public class UIUserManagementController {
    ...
    public List<UserDto> updateUsers(@Valid @RequestBody List<Map<String, Object>> userDtos) {
		return userManagerService.updateUser(userDtos);
    }
    
    @PostMapping("/users/password/resert")
    public ResponseDto<?> resertPassword(@Valid @RequestBody List<Map<String, Object>> userDtos) {
