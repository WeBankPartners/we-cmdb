...
INSERT INTO `adm_basekey_cat` (`id_adm_basekey_cat`, `cat_name`, `description`, `id_adm_role`, `id_adm_basekey_cat_type`, `group_type_id`) VALUES
	...
	(69, 'orchestration', '编排', NULL, 31, NULL),
	(70, 'zone_link_type', NULL, NULL, 20, NULL),
	(71, 'host_deploy_user_orchestration', '编排', NULL, 32, NULL),
	(72, 'qcloud_security', '腾讯云安全', NULL, 1, NULL),
	(74, 'zsf_test', NULL, NULL, 3, NULL);
...
INSERT INTO `adm_basekey_code` (`id_adm_basekey`, `id_adm_basekey_cat`, `code`, `value`, `group_code_id`, `code_description`, `seq_no`, `status`) VALUES
	...
	(5, 1, 'PDL', '规划设计层', NULL, NULL, 6, 'active'),
	...
	(241, 58, 'wecube1567589381828', '创建VPC子网路由表', NULL, NULL, 1, 'active'),
	(242, 70, 'PEERCONNECTION', '对等连接', NULL, NULL, 1, 'active'),
	(243, 70, 'NAT', 'NAT网关', NULL, NULL, 2, 'active'),
	(244, 59, 'wecube1567672568817', '对等连接及路由添加', NULL, NULL, 1, 'active'),
	(245, 72, 'seed123456', '腾讯云安全种子', NULL, NULL, 1, 'active'),
	(248, 58, 'wecube1569310936541', '新建编排1', NULL, NULL, 2, 'active');
