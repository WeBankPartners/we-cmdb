...
INSERT INTO `sys_ci_template_attr` (`id`, `ci_template`, `name`, `display_name`, `description`, `status`, `input_type`, `data_type`, `data_length`, `text_validate`, `ref_ci_type`, `ref_name`, `ref_type`, `ref_filter`, `ref_update_state_validate`, `ref_confirm_state_validate`, `select_list`, `ui_search_order`, `ui_form_order`, `unique_constraint`, `ui_nullable`, `nullable`, `editable`, `display_by_default`, `permission_usage`, `reset_on_edit`, `source`, `customizable`, `autofillable`, `autofill_rule`, `autofill_type`, `edit_group_control`, `edit_group_value`) VALUES ('create_destroy__asset_id','create_destroy','asset_id','资产ID','资产ID','notCreated','text','varchar',64,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,4,5,'yes','yes','yes','yes','yes','no','no','template','no','no',NULL,NULL,'no',NULL);
INSERT INTO `sys_ci_template_attr` (`id`, `ci_template`, `name`, `display_name`, `description`, `status`, `input_type`, `data_type`, `data_length`, `text_validate`, `ref_ci_type`, `ref_name`, `ref_type`, `ref_filter`, `ref_update_state_validate`, `ref_confirm_state_validate`, `select_list`, `ui_search_order`, `ui_form_order`, `unique_constraint`, `ui_nullable`, `nullable`, `editable`, `display_by_default`, `permission_usage`, `reset_on_edit`, `source`, `customizable`, `autofillable`, `autofill_rule`, `autofill_type`, `edit_group_control`, `edit_group_value`) VALUES ('create_destroy__code','create_destroy','code','编码','编码','notCreated','text','varchar',64,'[0-9a-zA-Z]{2,10}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,3,'no','yes','yes','yes','yes','no','no','template','yes','no',NULL,NULL,'no',NULL);
...
INSERT INTO `sys_ci_template_attr` (`id`, `ci_template`, `name`, `display_name`, `description`, `status`, `input_type`, `data_type`, `data_length`, `text_validate`, `ref_ci_type`, `ref_name`, `ref_type`, `ref_filter`, `ref_update_state_validate`, `ref_confirm_state_validate`, `select_list`, `ui_search_order`, `ui_form_order`, `unique_constraint`, `ui_nullable`, `nullable`, `editable`, `display_by_default`, `permission_usage`, `reset_on_edit`, `source`, `customizable`, `autofillable`, `autofill_rule`, `autofill_type`, `edit_group_control`, `edit_group_value`) VALUES ('design__code','design','code','编码','编码','notCreated','text','varchar',64,'[0-9a-zA-Z]{2,10}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,3,'no','yes','yes','yes','yes','no','no','template','yes','no',NULL,NULL,'no',NULL);
...
INSERT INTO `sys_ci_template_attr` (`id`, `ci_template`, `name`, `display_name`, `description`, `status`, `input_type`, `data_type`, `data_length`, `text_validate`, `ref_ci_type`, `ref_name`, `ref_type`, `ref_filter`, `ref_update_state_validate`, `ref_confirm_state_validate`, `select_list`, `ui_search_order`, `ui_form_order`, `unique_constraint`, `ui_nullable`, `nullable`, `editable`, `display_by_default`, `permission_usage`, `reset_on_edit`, `source`, `customizable`, `autofillable`, `autofill_rule`, `autofill_type`, `edit_group_control`, `edit_group_value`) VALUES ('start_stop__asset_id','start_stop','asset_id','资产ID','资产ID','notCreated','text','varchar',64,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,4,5,'yes','yes','yes','yes','yes','no','no','template','no','no',NULL,NULL,'no',NULL);
INSERT INTO `sys_ci_template_attr` (`id`, `ci_template`, `name`, `display_name`, `description`, `status`, `input_type`, `data_type`, `data_length`, `text_validate`, `ref_ci_type`, `ref_name`, `ref_type`, `ref_filter`, `ref_update_state_validate`, `ref_confirm_state_validate`, `select_list`, `ui_search_order`, `ui_form_order`, `unique_constraint`, `ui_nullable`, `nullable`, `editable`, `display_by_default`, `permission_usage`, `reset_on_edit`, `source`, `customizable`, `autofillable`, `autofill_rule`, `autofill_type`, `edit_group_control`, `edit_group_value`) VALUES ('start_stop__code','start_stop','code','编码','编码','notCreated','text','varchar',64,'[0-9a-zA-Z]{2,10}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,3,3,'no','yes','yes','yes','yes','no','no','template','yes','no',NULL,NULL,'no',NULL);
